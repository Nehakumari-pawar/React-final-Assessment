...
const Cart = () => {
    ...
    const diffToast =() =>
    {
        alert('order placed successfully!!!!')     //Using a function for clearing the cart once user click on Buy Now button
    ...
    return (
        <div className="cart">
                    ...
                    <div className="col-3 summary-col">
                        <div className="summary">
                            ...
                            <div className="summary__details">
                                ...
                                <button type="button" className="checkout" onClick={diffToast}>Buy Now</button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <button className="btnback" onClick={() => history.push('/home')}>Continue Shopping &larr;</button>
        </div>
